                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="" action="<?= site_url('blog/add-blog') ?>" method="post">
                                    <?= csrf__() ?>
                                  
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="blogTitle" class="form-label">Blog Title</label>
                                            <input type="text" class="form-control" id="blogTitle" name="blog_title" value="<?= set_value('blog_title') ?>" placeholder="Enter blog title">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control" id="mytextarea1" name="content" rows="6" placeholder="Enter blog content"><?= set_value('content') ?></textarea>
                                    ...
                                    <div class="row">
                                                ...
                                                <optgroup label="<?= $msp->name ?>">
                                                    <?php foreach($get_categories as $val): ?>
                                                        <?php if($val->is_parent == $msp->id): ?>
                                                            <option value="<?= $val->id ?>" <?= set_select('category',$val->id) ?>><?= $val->name ?></option>
                                                        <?php endif; ?>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                                <?php endforeach; ?>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="blogTags" name="tags" placeholder="Enter blog tags (comma-separated)">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="blogAuthor" name="author" placeholder="Enter author name">
