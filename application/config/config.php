...
$config['api_key'] = '242942-0599-80834-9430';
...
|
*/
$config['log_threshold'] = 4; // Set the desired logging threshold (0 = no logging, 4 = all logs)
$config['log_path'] = APPPATH . 'logs/'; // Set the path where log files will be saved
...
$config['csrf_exclude_uris'] =  array(
                                    ...
                                    'export-mail-log',
                                    'send-secret-pin',
                                    'security/generate-secret-pin',
                                    'delete-smtp',
                                    'send-mail',
                                    'delete-mail-logs',

                                    'web/export-search-history', // web
                                    'web/delete-search-history',
                                    'web/delete-contact',
                                    'web/export-contacts', // end web
                                    'webhook/generate-webhook',
                                    'api/v2/webhook',
                                    'api/v2/webhook/[0-9A-Za-z]+',
                                    'api/v2/WebContact/[0-9A-Za-z]+',
                                    'api/v2/contact/[0-9A-Za-z]+',
                                    'delete-notification',
                                    'web/capture-lead/[0-9A-Za-z]+',
                                    'web/form/[0-9A-Za-z]+',
                                    ...
                                    // Employee CSRF
                                    'employee/fetch-roles', 
                                    'employee/update-attendance-status',
                                    'employee/update-leave-status',

                                    // Masters CSRF
                                    'master/pager-limit',
                                    'master/update-source',
                                    'master/update-category',
                                    'master/menu-permission-access',
                                    'master/menu-permissions',

                                    // History CSRF
                                    'history/delete-login-history',
                                    'history/export-history',

                                    // Leads CSRF
                                    'leads/update-leads-permissions',
                                    'leads/export-lead',
                                    'leads/import-lead',
                                    'leads/lead-assignment',
                                    'leads/delete-lead',
                                    'leads/update-call-status',
                                    'leads/add-remark',
                                    'leads/view-remark',
                                    'leads/delete-remark',

                                    // Upgrade Plan
                                    'subscription/check-plan-price',
                                    'subscription/update-order',

                                    // menu sorting
                                    'menu/update-menu-order',
