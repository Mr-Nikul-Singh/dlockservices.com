...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
  	...
  	<meta content="Setup Medicos" name="keywords">
    ...
    <!-- Style Css -->
    <link href="<?= base_url('assets/css/styles.min.css') ?>?v=<?= filemtime('assets/css/styles.min.css') ?>" rel="stylesheet">
    <!-- <link href="<?= base_url('assets/css/styles.css') ?>?v=<?= filemtime('assets/css/styles.css') ?>" rel="stylesheet"> -->
...
<body>
    ...
    <!-- Start Switcher -->
    <div class="offcanvas offcanvas-end d-none" tabindex="-1" id="switcher-canvas" aria-labelledby="offcanvasRightLabel">
                ...
                <div class="tab-pane fade border-0" id="switcher-profile" role="tabpanel" aria-labelledby="switcher-profile-tab" tabindex="0">
                    <div>
                        ...
                        <div class="theme-colors">
                            ...
                            <div class="d-flex switcher-style pb-2">
                                <div class="form-check switch-select me-3 d-none">
                                    <input class="form-check-input color-input color-dark" data-bs-toggle="tooltip"
                        ...
                        <div class="menu-image mb-3 d-none">
