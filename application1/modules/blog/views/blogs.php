                             ...
                             <div class="d-none d-md-block">
                                <div class="card-header justify-content-end">
                                    <div class="d-flex">
                                        ...
                                        <div class="me-2">
                                            <form action="<?= site_url("blog/posts") ?>" method="GET">
                                    ...
                                    <table class="table text-nowrap table-bordere table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="remove_<?= $val->id ?>">
                                                ...
                                                <td><?= $i++ ?></td>
                                                <td><?= truncate_text(decode($val->blog_title),26) ?></td>
                                                ...
                                                <td>
                                                    <a href="<?= site_url('blog/edit-blog/'.$val->id) ?>" class="btn btn-icon btn-wave waves-effect waves-light btn-sm btn-info-light"><i class="ti ti-edit"></i></a>
                                                    <a href="#" onclick="delete_record(<?= $val->id ?>,'blog/delete-post')" class="btn btn-icon btn-wave waves-effect waves-light btn-sm btn-danger-light"><i class="ti ti-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
