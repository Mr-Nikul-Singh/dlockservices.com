...
<?php require_once(APPPATH.'views/public/includes/light-navbar.inc.php'); ?>
        ...
        <!-- Home Start -->
        <section class="bg-half-170 d-table w-100 bg-light d-print-none" style="background: url('assets/public/images/bg/page.png') top center;" id="home">
            <div class="container">
                <div class="row mt-5">
                    <div class="col-lg-12">
                        <div class="title-heading text-center text-md-start">
                            <h3>Privacy Policy</h3>
                            <p class="text-muted para-desc mt-3 mb-0">Information about privacy policy</p> 
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Dlock Services.</p>
</li>
<li>
...
<ul>
<li>By email: <a href="#" class="" >contact@dlockservices.com</a></li>
</ul>
            </div>
