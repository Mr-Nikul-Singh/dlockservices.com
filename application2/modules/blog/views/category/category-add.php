                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="" action="<?= site_url('blog/add-blog-category') ?>" method="post">
                                    <?= csrf__() ?>
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="categoryName" class="form-label strong">Category Name</label>
                                            <input type="text" class="form-control" id="categoryName" name="category_name" value="<?= set_value('category_name') ?>" placeholder="Enter category name">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" id="parentCategory" name="parent_category">
                                                ...
                                                <?php foreach($get_parent_categories as $vls): ?>
                                                    <option value="<?= $vls->id ?>" <?= set_select('parent_category',$vls->id) ?>><?= $vls->name ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="categoryDescription" name="description" rows="4" placeholder="Enter category description"><?= set_value('description') ?></textarea>
