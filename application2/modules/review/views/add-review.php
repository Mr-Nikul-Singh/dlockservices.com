                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= site_url('review/add-review') ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <!-- Reviewer Name -->
                                    <div class="mb-4 col-xl-6">
                                        ...
                                        <input type="text" class="form-control" id="reviewer_name" name="reviewer_name" placeholder="Enter your name" 
                                            value="<?= set_value('reviewer_name'); ?>" required>
                                    ...
                                    <div class="mb-4 col-xl-12">
                                        ...
                                        <textarea class="form-control" id="review_text" name="review_text" rows="4" placeholder="Enter your review here..." required><?= set_value('review_text'); ?></textarea>
