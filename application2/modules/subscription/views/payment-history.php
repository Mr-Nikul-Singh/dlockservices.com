                                    ...
                                    <tbody>
                                        ...
                                        <tr id="remove_<?= $val->id ?>">
                                            ...
                                            <td class="text-center">
                                                <a href="<?= site_url('subscription/payment-receipt/'.$val->id) ?>" target="_new" class="btn btn-icon btn-wave waves-effect waves-light btn-sm btn-success-light"><i class="ti ti-printer"></i></a>
