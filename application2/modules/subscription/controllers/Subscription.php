	...
	public function add_plan(){
		...
		if(!empty($_POST)):
			...
			$data = [
				...
				'plan_name'     => $this->input->post('plan_name', true),
				'disk_space'    => $this->input->post('disk_space', true),
				'available_os'  => json_encode($this->input->post('os', true)),
				'db_softwares'  => json_encode($this->input->post('db_softwares', true)),
				'cpanels_list'  => json_encode($this->input->post('cpanels_list', true)),
