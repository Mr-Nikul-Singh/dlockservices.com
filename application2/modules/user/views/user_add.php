                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= site_url('user/add-user') ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                                    <?= csrf__() ?>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="row">
                                                <div class="col-xl-3 mb-3">
                                                    ...
                                                    <input type="text" value="<?= set_value('username') ?>" autocomplete="off" class="form-control" name="username">
                                                ...
                                                <!-- <div class="col-xl-3 mb-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control form-control-sm"  id="secret_pin" name="secret_pin" value="<?= set_value('secret_pin') ?>">
